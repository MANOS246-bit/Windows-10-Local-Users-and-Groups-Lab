...
* [Open Control Panel](./screenshots/open-control-panel.png)
* [Verify Standard User Account](./screenshots/verify-standard-user-account.png)
* [Administrator Password Required](./screenshots/uac-administrator-password-required.png)
